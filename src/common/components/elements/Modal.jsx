import "./Modal.css";
export default function Modal({message, closeModal, showModal}){
    return ( 
        <div className="x-modal">
            <div className="x-modal-cover" title="Quidi" onClick={closeModal}></div>
            <div className="x-modal-content">
                <span className="x-modal-close" title="Quidi" onClick={closeModal}>
